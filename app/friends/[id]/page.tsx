  ...
  return (
    <div className=" text-white min-h-screen flex flex-col justify-between">
      <div>
        ...
        <div className="p-4">
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-[#9caaba] text-base font-normal">$0.00</p>
            </div>
            <Button
              type="primary"
        ...
        <div className="flex !text-[#ff6666] items-center gap-4 bg-[#111418] px-4 min-h-[72px] py-2 justify-between">
        ...
        <div className="flex !text-[#248f24]  items-center gap-4 bg-[#111418] px-4 min-h-[72px] py-2 justify-between">
          <div className=" flex flex-col justify-center">
            <p className=" text-base font-medium leading-normal line-clamp-1">
              Dinner
            </p>
