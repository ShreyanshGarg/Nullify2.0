...
import { CloseOutlined, RightSquareFilled, CaretRightFilled } from "@ant-design/icons";
                ...
                >
                    <div className="flex flex-col items-center justify-center gap-4 h-full py-10 mt-20">
                        ...
                        <div className="text-center mt-4">
                            <p className="text-lg font-semibold">You paid Sophia.</p>
                            <p className="text-sm text-gray-500">sophia@gmail.com</p>
                        </div>
                    </div>
